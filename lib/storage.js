...
export const P = {
  ...
  // Week completion — keyed by week so last week's ticks don't bleed through
...
// Returns the ISO date of the Monday of the current week — used as a weekly cache key.
// Data auto-scopes to this week; last week's completions don't carry over.
