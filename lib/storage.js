...
function _defaultTrainingState() {
  return {
    ...
    lifts: {},                          // keyed by canonical exercise name
                                        //   per-lift state includes Phase 2 (currentWeight, e1RM,
                                        //   stallSignal, consecutiveHolds, history) PLUS Phase 3
                                        //   recovery fields (inRecoveryUntil, preDeloadWeight) that
                                        //   are populated when a deload completes. See progression.js
                                        //   for the full lift-state contract.
    ...
    mesocycle: {
      ...
      activeDeload: null,               // Phase 3: { startedAt, plannedDays, triggeredBy,
                                        //   triggeredLifts, preDeloadWeights } when in deload
      deloadSignals: {
