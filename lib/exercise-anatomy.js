...
export const PATTERN_DEFAULTS = {
  ...
  hinge: {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Back: 0.3, Forearms: 0.3, Core: 0.3 },
  },
  lunge: {
    primary: "Quads",
  ...
  power: {
    // Olympic lifts — full body explosive
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Back: 0.5, "Front Delts": 0.4, Quads: 0.5, Calves: 0.3, Forearms: 0.3, Core: 0.4 },
  },
  carry: {
    primary: "Forearms",
...
export const EXERCISE_ANATOMY = {
  ...
  "Hex Bar Deadlift": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Back: 0.4, Quads: 0.4, Forearms: 0.4, Core: 0.35, Calves: 0.15 },
  },
  ...
  "Pull-Up": {
    primary: "Back",
    secondary: { Biceps: 0.5, "Rear Delts": 0.25, Core: 0.25, Forearms: 0.3 },
  },
  ...
  "Power Clean": {
    primary: "Hamstrings",
    secondary: { Glutes: 0.6, Back: 0.5, "Front Delts": 0.4, Quads: 0.5, Calves: 0.3, Forearms: 0.4, Core: 0.4 },
  },
  "DB Walking Lunge": {
    primary: "Quads",
    secondary: { Glutes: 0.55, Hamstrings: 0.25, Calves: 0.2, Core: 0.25 },
  ...
  "Tricep Dips": {
    primary: "Triceps",
    secondary: { Chest: 0.3, "Front Delts": 0.2 },
  },
  "Skullcrusher": {
    primary: "Triceps",
    secondary: {},
